# -*- coding: utf-8 -*-
"""
Minimal fix to Read_data.py - handles duplicates in MultiIndex
"""
...
# MINIMAL FIX 1: Add missing column with default value
...
for row in range(len(dataset)):
    ...
    # MINIMAL FIX 2: Make the last element unique by adding row number to prevent duplicates
    temp_df.columns = pd.MultiIndex.from_tuples([(
        information.Description,
        information['Replace blanks with #N/A'],
        information.Category,
        information['Region from'],
        information['Region to'],
        information.Ticker,
        f"{information.Ticker}_{row}"  # Make unique by adding row number
    )])
