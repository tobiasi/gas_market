# -*- coding: utf-8 -*-
"""
Updated version of Read_data.py to work with bloomberg_raw_data.csv
Uses CSV fallback instead of Bloomberg API for testing
"""
...
print("Processing tickers and building MultiIndex structure...")
...
if not target_rows.empty:
    ...
    print(f"  Italy: {target_rows['Italy'].iloc[0]:.2f}")
    print(f"  Germany: {target_rows['Germany'].iloc[0]:.2f}")
    print(f"  France: {target_rows['France'].iloc[0]:.2f}")
